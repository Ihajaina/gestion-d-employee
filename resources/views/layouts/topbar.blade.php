                    ...
                    <div class="app-utility-item app-notifications-dropdown dropdown">
                        ...
                        <div class="dropdown-menu p-0" aria-labelledby="notifications-dropdown-toggle">
                            ...
                            <div class="dropdown-menu-content">
                                <div class="item p-3">
                                    <div class="row gx-2 justify-content-between align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="info">
                                                <div class="desc">Bonjour Ihajaina</div>
                                                <div class="meta"> Il y a 2 heures</div>
                                            </div>
                                        </div>
                                        <!--//col-->
                                    </div>
                                ...
                                <div class="item p-3">
                                    <div class="row gx-2 justify-content-between align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="info">
                                                <div class="desc">Concernant notre rendez-vous de tout a l'heure</div>
                                                <div class="meta"> Il y a un jour</div>
                                            </div>
                                        </div>
                                        <!--//col-->
                                    </div>
                                ...
                                <div class="item p-3">
                                    <div class="row gx-2 justify-content-between align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="info">
                                                <div class="desc">Etes-vous disponible ce soir avec Monsieur le PDG ?</div>
                                                <div class="meta"> Il y a 3 jours</div>
                                            </div>
                                        </div>
                                        <!--//col-->
                                    </div>
                                ...
                                <div class="item p-3">
                                    <div class="row gx-2 justify-content-between align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="info">
                                                <div class="desc"> James vous a envoye un nouveau message.</div>
                                                <div class="meta"> Il y 7 jours</div>
                                            </div>
                                        </div>
                                        <!--//col-->
                                    </div>
                            ...
                            <div class="dropdown-menu-footer p-2 text-center">
                                <a href="notifications.html">Voir</a>
                            </div>
